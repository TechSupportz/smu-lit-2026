...
export const categories = [
 ...
 { value: 'tenancy', label: 'A rental deposit', detail: 'Residential tenancy of no more than 2 years' },
...
export const checklistItems = [
 {id:'filed', title:'File your claim and pay the filing fee',description:'Use CJTS to complete the official pre-filing assessment, submit your claim and supporting documents, and make payment.',link:'https://www.judiciary.gov.sg/civil/how-to-file-serve-small-claim',linkLabel:'Filing and payment guide'},
 {id:'served',title:'Serve the respondent',description:'Follow the court’s instructions to deliver the claim and Notice of Consultation to the respondent. Keep your proof of service.',link:'https://www.judiciary.gov.sg/civil/how-to-file-serve-small-claim',linkLabel:'How to serve your claim'},
 {id:'declaration',title:'File your Declaration of Service',description:'Record how and when the documents were served in CJTS, and attach your proof before the first consultation.',link:'https://www.judiciary.gov.sg/civil/before-going-to-court-small-claim',linkLabel:'Before your consultation'},
]
