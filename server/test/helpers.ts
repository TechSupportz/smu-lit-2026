...
export function testConfig(dir: string, overrides: Partial<AppConfig> = {}): AppConfig {
  return {
    ...
    openCodeGoModel: 'muse-spark-1.3-contributor',
    openRouterApiKey: '',
    openRouterBaseUrl: 'https://openrouter.ai/api/v1',
    openRouterExtractionModel: 'google/gemini-3.8-flash',
    host: '127.0.0.1',
    port: 3000,
...
export function createCase(store: CaseStore, input: Partial<Parameters<CaseStore['createCase']>[0]> = {}) {
